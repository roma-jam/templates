...
void pin_enable(unsigned int pin, unsigned int param)
{
#ifdef LPC11Uxx
    IOCON[pin] = param;
#else //LPC18xx
...
void gpio_enable(unsigned int pin, GPIO_MODE mode, uint8_t dir)
{
...
void pin_reset(unsigned int pin)
{
    LPC_GPIO->B[pin] = 0;
}
