...
#define SRAM1_RESERVED_SZ               0x2000
...
#ifdef BANK2
#define FLASH_BASE                  0x00040000
#endif
#endif //FLASH_BASE

#define FLASH_BASE_BANK_ADDR        0x1A000000

#if !defined(BANK0) && !defined(BANK1) && !defined(BANK2)
